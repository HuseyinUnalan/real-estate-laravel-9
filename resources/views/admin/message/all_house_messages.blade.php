            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Ev Mesaj Listesi</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item active">Ev Mesaj Listesi</li>
                            </ol>
                        </div>
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($messages as $item)
                                                    <tr class="odd">
                                                        ...
                                                        <td>
                                                            <a href="{{ route('detail.house.message', $item->id) }}">
                                                            ...
                                                            <a href="{{ route('delete.house.message', $item->id) }}"
                                                                id="delete">
