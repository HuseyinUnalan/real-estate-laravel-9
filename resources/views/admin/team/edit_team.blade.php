    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <form action="{{ route('update.team') }}" method="POST" enctype="multipart/form-data">
                ...
                <input type="hidden" name="old_image" value="{{ $teams->photo }}">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <img id="showImage" class="rounded avatar-xl"
                                            src="{{ !empty($teams->photo) ? url($teams->photo) : url('upload/no_image.jpg') }}"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" name="name" value="{{ $teams->name }}"
                                            type="text" required>
                                    </div>
                                </div>
                                <!-- end row -->
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" name="position" value="{{ $teams->position }}"
                                            type="text" required>
                                    </div>
                                </div>
                                <!-- end row -->
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" name="desk" value="{{ $teams->desk }}"
                                            type="text" required>
                                    </div>
                                </div>
                                <!-- end row -->
