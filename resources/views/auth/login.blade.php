...
<head>
    ...
    <meta charset="utf-8" />
    <title> {{ $settings->title }} | Login Admin</title>
                    ...
                    <div class="text-center mt-4">
                        <div class="mb-3">
                            <a href="index.html" class="auth-logo">
                                <img src="{{ asset($settings->logo) }}" height="120" class="logo-dark mx-auto"
                                    alt="">
                                <img src="{{ asset($settings->logo) }}" height="120" class="logo-light mx-auto"
                                    alt="">
                            </a>
                        </div>
                    </div>
