                    ...
                    <div class="item-shorting-box mt-4 bg-white border rounded px-3 py-3 mb-5">
                        ...
                        <div class="item-shorting-box-right">
                            ...
                            <ul class="shorting-list">
                                <li><a href="#" id="grid-view" class="active border"><i
                                            class="fas fa-table-cells-large"></i></a></li>
                                <li><a href="#" id="list-view" class="border"><i class="fas fa-list"></i></a>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <nav aria-label="Page navigation example">
                        <div class="pagination-wrap">
                            {{ $houses->links('vendor.pagination.house_default') }}
                        </div>
                    </nav>
                </div>
            </div>
